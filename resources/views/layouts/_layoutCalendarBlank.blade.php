  ...
  <style>
    .swal-wide{
      width:850px !important;
		...
		.fc-sun { color:red; } 
		.diaFestivo { background-color:red; } 
  </style>
</head>
...
<!-- begin::Body -->
<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default" style="background-image:url('./assets/app/media/img/icons/GRANOS-TRIGO.png')">
  
  <!-- begin:: Page -->
  <div class="m-grid m-grid--hor m-grid--root m-page">
    <div class="m-content" style="padding:5%;">
      @yield('content')
    </div>
  </div>
  <!-- end:: Page -->
