	...
	<ul class="m-menu__nav m-menu__nav--submenu-arrow ">
		...
		<li class="m-menu__item m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
			<a href="{{route('programacion')}}" class="m-menu__link m--font-danger" title="">
				...
				<span class="m-menu__link-text m--font-danger">{{Auth::user()->isAdmin()?'MI PROGRAMACION':'PROGRAMACION'}}</span>
			</a>
        </li>
        ...
        <li class="m-menu__item m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
			<a href="javascript:;" class="m-menu__link m-menu__toggle" title=""><i class="m-menu__link-icon flaticon-customer"></i><span class="m-menu__link-text">NOMINA</span><i class="m-menu__hor-arrow la la-angle-down"></i><i class="m-menu__ver-arrow la la-angle-right"></i></a>
			<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
				...
				<ul class="m-menu__subnav">
					...
					<li class="m-menu__item " aria-haspopup="true">
						<a href="/liquidarNominaSiesa" class="m-menu__link " ><i class="m-menu__link-icon flaticon-paper-plane-1"></i><span class="m-menu__link-text">NOMINA A SIESA</span></a>
                    </li>
                    <li class="m-menu__item m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
                    ...
                    <li class="m-menu__item " aria-haspopup="true">
						<a href="/cierres" class="m-menu__link " ><i class="m-menu__link-icon flaticon-calendar-with-a-clock-time-tools"></i><span class="m-menu__link-text">FECHAS CIERRE NOMINA</span></a>
                    </li>
				</ul>
			</div>
		</li>
